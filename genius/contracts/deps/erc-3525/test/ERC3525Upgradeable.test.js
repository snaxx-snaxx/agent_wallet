...
async function deployERC3525(name, symbol, decimals) {
  const ERC3525Factory = await ethers.getContractFactory('ERC3525BaseMockUpgradeableWithInit');
...
describe('ERC3525Upgradeable', () => {
  ...
  shouldBehaveLikeERC3525('ERC3525Upgradeable');
  shouldBehaveLikeERC3525Metadata('ERC3525MetadataUpgradeable');
